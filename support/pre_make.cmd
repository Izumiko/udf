...
@"C:\Program Files\ANSYS Inc\v222\fluent\\ntbin\\win64\\sed.exe" -n "s/^ *\(DEFINE_[_A-Z]*(.*)\)/extern \1;/p" DPM.cpp >> udf_names.c
@echo __declspec(dllexport) UDF_Data udf_data[] = { >> udf_names.c
@"C:\Program Files\ANSYS Inc\v222\fluent\\ntbin\\win64\\sed.exe" -n "s/^ *DEFINE_\([_A-Z]*\)( *\([_a-zA-Z0-9]*\).*)/\{\"\2\", (void (*)(void))\2, UDF_TYPE_\1\},/p" DPM.cpp >> udf_names.c
@echo }; >> udf_names.c
...
@echo } >> udf_names.c
"C:\Program Files\ANSYS Inc\v222\fluent\\ntbin\\win64\\resolve.exe" -udf DPM.cpp -head_file ud_io1.h
